...
--> statement-breakpoint
ALTER TABLE "documents" ADD COLUMN "source_type" varchar(30) DEFAULT 'document' NOT NULL;--> statement-breakpoint
ALTER TABLE "documents" ADD COLUMN "tags" text[] DEFAULT '{}'::text[] NOT NULL;--> statement-breakpoint
ALTER TABLE "messages" ADD COLUMN "status" varchar(20) DEFAULT 'ok' NOT NULL;--> statement-breakpoint
...
CREATE INDEX "auth_attempts_ip_idx" ON "auth_attempts" USING btree ("ip");--> statement-breakpoint
